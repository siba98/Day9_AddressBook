...
namespace Day9_AddressBook
{
    class UC3_UpdateExistingContact
    {
        ...
        public static List<UC3_UpdateExistingContact> People = new List<UC3_UpdateExistingContact>();

        public static void NewContact()
        {
            UC3_UpdateExistingContact person = new UC3_UpdateExistingContact();
        ...
        public static void PrintingDetails(UC3_UpdateExistingContact person)
        {
